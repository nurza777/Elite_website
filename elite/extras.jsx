...
/* Site-wide contacts from the admin "office" key (floating chat) */
const _FC_CT = (window.eaContent && window.eaContent("office", null)) || {};
        ...
        <div className="fchat__menu">
          ...
          <a href={"https://wa.me/" + ((_FC_CT.whatsapp || _FC_CT.phone || "996555720712")).replace(/\D/g, "")} target="_blank" rel="noopener" className="fchat__opt fchat__opt--wa">
            ...
            <div className="fchat__opt-txt">
              ...
              <span>{_FC_CT.whatsapp || _FC_CT.phone || "+996 555 720 712"}</span>
            </div>
          </a>
          <a href={_FC_CT.telegram || "https://t.me/eliteacademykg"} target="_blank" rel="noopener" className="fchat__opt fchat__opt--tg">
            <span className="fchat__opt-ic" aria-hidden="true">
            ...
            <div className="fchat__opt-txt">
              ...
              <span>{"@" + (_FC_CT.telegram || "https://t.me/eliteacademykg").split("/").pop().replace("@", "")}</span>
            </div>
          </a>
          <a href={"tel:+" + (_FC_CT.phone || "+996 555 720 712").replace(/\D/g, "")} className="fchat__opt fchat__opt--call">
            <span className="fchat__opt-ic" aria-hidden="true">
